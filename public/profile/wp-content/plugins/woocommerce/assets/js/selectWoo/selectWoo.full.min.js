...
! function(n) {
    ...
    (u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? e = u : u = {}, g = {}, m = {}, y = {}, v = {}, n = Object.prototype.hasOwnProperty, i = [].slice, w = /\.js$/, h = function(e, t) {
            var n, i, o = c(e),
                s = o[0],
                t = t[1];
            ...
            return e.Extend(i, e.Observable), i.prototype.render = function() {
                ...
                var t = this.options.get("escapeMarkup"),
                    n = (this.clear(), this.hideLoading(), d('<li role="alert" aria-live="assertive" class="select2-results__option"></li>')),
                ...
                for (t in e.disabled && (delete i["data-selected"], i["aria-disabled"] = "true"), null == e.id && delete i["data-selected"], null != e._resultId && (n.id = e._resultId), e.title && (n.title = e.title), e.children && (i["aria-label"] = e.text, delete i["data-selected"]), i) {
                    var o = i[t];
                    n.setAttribute(t, o)
                }
                if (e.children) {
                    for (var s = d(n), r = document.createElement("strong"), a = (r.className = "select2-results__group", d(r)), l = (this.template(e, r), a.attr("role", "presentation"), []), c = 0; c < e.children.length; c++) {
                        var u = e.children[c],
                            u = this.option(u);
                        l.push(u)
                    }
                ...
                this.$results.attr("id", n), t.on("results:all", function(e) {
                    ...
                    var t = d(this),
                        n = t.data("data");
                    "true" === t.attr("data-selected") ? o.options.get("multiple") ? o.trigger("unselect", {
                        originalEvent: e,
                        data: n
                ...
                0 !== o.length && (e = this.$results.find("[data-selected]").index(o), t = this.$results.offset().top, i = o.offset().top, n = this.$results.scrollTop() + (i - t), i = i - t, n -= 2 * o.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (i > this.$results.outerHeight() || i < 0) && this.$results.scrollTop(n))
            ...
            return i.Extend(s, t), s.prototype.render = function() {
                ...
                var n = this,
                    i = (s.__super__.bind.apply(this, arguments), t.id + "-container"),
                    o = (this.$selection.find(".select2-selection__rendered").attr("id", i).attr("role", "textbox").attr("aria-readonly", "true"), this.options.get("label"));
                ...
                var t, n;
                0 === e.length ? this.clear() : (e = e[0], t = this.$selection.find(".select2-selection__rendered"), n = i.entityDecode(this.display(e, t)), t.empty().text(n), t.prop("title", e.title || e.text))
            }, s
            ...
            return t.prototype.render = function(e) {
                ...
                var i = this,
                    o = n.id + "-results",
                    t = (e.call(this, n, t), n.on("open", function() {
            ...
            return i.Extend(n, i.Observable), n.prototype.current = function(e) {
                ...
                var n = (n = (n = "") + (null != e ? e.id : i.generateChars(4)) + "-result-") + i.generateChars(4);
                return null != t.id ? n += "-" + t.id.toString() : n += "-" + i.generateChars(4), n
            }, n
            ...
            return t.Extend(n, e), n.prototype.current = function(e) {
                ...
                var e, s = this;
                o.selected = !0, r(o.element).is("option") ? (o.element.selected = !0, this.$element.trigger("change")) : this.$element.prop("multiple") ? this.current(function(e) {
                    var t = [];
                    (o = [o]).push.apply(o, e);
                ...
                var s = this;
                this.$element.prop("multiple") && (o.selected = !1, r(o.element).is("option") ? (o.element.selected = !1, this.$element.trigger("change")) : this.current(function(e) {
                    for (var t = [], n = 0; n < e.length; n++) {
                        var i = e[n].id;
            ...
            return t.Extend(n, e), n.prototype._applyDefaults = function(e) {
                ...
                var i = this,
                    o = (null != this._request && ("function" == typeof this._request.abort && this._request.abort(), this._request = null), s.extend({
                        type: "GET"
                    }, this.ajaxOptions));
            ...
            return t.prototype.render = function(e) {
                var e = e.call(this),
                    t = s('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="text" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="combobox" aria-autocomplete="list" aria-expanded="true" /></span>');
        ...
        }), u.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(u, d, p, h, f, g, m, y, v, w, _, t, $, b, x, A, C, S, O, E, D, T, q, j, L, k, P, I, e) {
            function n() {
                this.reset()
            }
            return n.prototype.apply = function(e) {
                if (null == (e = u.extend(!0, {}, this.defaults, e)).dataAdapter && (null != e.ajax ? e.dataAdapter = x : null != e.data ? e.dataAdapter = b : e.dataAdapter = $, 0 < e.minimumInputLength && (e.dataAdapter = w.Decorate(e.dataAdapter, S)), 0 < e.maximumInputLength && (e.dataAdapter = w.Decorate(e.dataAdapter, O)), 0 < e.maximumSelectionLength && (e.dataAdapter = w.Decorate(e.dataAdapter, E)), e.tags && (e.dataAdapter = w.Decorate(e.dataAdapter, A)), null == e.tokenSeparators && null == e.tokenizer || (e.dataAdapter = w.Decorate(e.dataAdapter, C)), null != e.query && (r = d(e.amdBase + "compat/query"), e.dataAdapter = w.Decorate(e.dataAdapter, r)), null != e.initSelection && (r = d(e.amdBase + "compat/initSelection"), e.dataAdapter = w.Decorate(e.dataAdapter, r))), null == e.resultsAdapter && (e.resultsAdapter = p, null != e.ajax && (e.resultsAdapter = w.Decorate(e.resultsAdapter, j)), null != e.placeholder && (e.resultsAdapter = w.Decorate(e.resultsAdapter, q)), e.selectOnClose && (e.resultsAdapter = w.Decorate(e.resultsAdapter, P))), null == e.dropdownAdapter && (e.multiple ? e.dropdownAdapter = D : (r = w.Decorate(D, T), e.dropdownAdapter = r), 0 !== e.minimumResultsForSearch && (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, k)), e.closeOnSelect && (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, I)), null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass || (r = d(e.amdBase + "compat/dropdownCss"), e.dropdownAdapter = w.Decorate(e.dropdownAdapter, r)), e.dropdownAdapter = w.Decorate(e.dropdownAdapter, L)), null == e.selectionAdapter && (e.multiple ? e.selectionAdapter = f : e.selectionAdapter = h, null != e.placeholder && (e.selectionAdapter = w.Decorate(e.selectionAdapter, g)), e.allowClear && (e.selectionAdapter = w.Decorate(e.selectionAdapter, m)), e.multiple && (e.selectionAdapter = w.Decorate(e.selectionAdapter, y)), null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass || (r = d(e.amdBase + "compat/containerCss"), e.selectionAdapter = w.Decorate(e.selectionAdapter, r)), e.selectionAdapter = w.Decorate(e.selectionAdapter, v)), "string" == typeof e.language && (0 < e.language.indexOf("-") ? (r = e.language.split("-")[0], e.language = [e.language, r]) : e.language = [e.language]), Array.isArray(e.language)) {
                    for (var t = new _, n = (e.language.push("en"), e.language), i = 0; i < n.length; i++) {
                        var o = n[i],
                            s = {};
                        try {
                            s = _.loadPath(o)
                            ...
                            try {
                                o = this.defaults.amdLanguageBase + o, s = _.loadPath(o)
                            } catch (c) {
            ...
            var a = function(e, t) {
                null != e.data("select2") && e.data("select2").destroy(), this.$element = e, this.id = this._generateId(e), this.options = new s(t = t || {}, e), a.__super__.constructor.call(this);
            ...
            return t.prototype.render = function(e) {
                var n, e = e.call(this),
                    ...
                    i = ("function" == typeof t && (t = t(this.$element)), this.options.get("adaptContainerCssClass")),
                    o = (i = i || r, -1 !== t.indexOf(":all:") && (t = t.replace(":all:", ""), n = i, i = function(e) {
                        var t = n(e);
                        return null != t ? t + " " + e : e
                    }), this.options.get("containerCss") || {});
                return "function" == typeof o && (o = o(this.$element)), s.syncCssClasses(e, this.$element, i), e.css(o), e.addClass(t), e
            }, t
            ...
            return t.prototype.render = function(e) {
                var n, e = e.call(this),
                    ...
                    i = ("function" == typeof t && (t = t(this.$element)), this.options.get("adaptDropdownCssClass")),
                    o = (i = i || r, -1 !== t.indexOf(":all:") && (t = t.replace(":all:", ""), n = i, i = function(e) {
                        var t = n(e);
                        return null != t ? t + " " + e : e
    ...
    var e, p, s, r, h, f, g, m, y, v, n, i, w, o, a = {
        define: u.define,
        require: u.require
    };
    ...
    function x(e) {
        var t;
        if (_(m, e) && (t = m[e], delete m[e], v[e] = !0, s.apply(p, t)), _(g, e) || _(v, e)) return g[e];

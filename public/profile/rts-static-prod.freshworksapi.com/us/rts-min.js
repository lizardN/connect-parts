    ...
    return t.prototype = {
        ...
        initializeSocket: function() {
            ...
            this.checkCookieSupport(function(t) {
                ...
                o.nocookie = t, 1 != o.clientClose && (n = o._getQueryParams(t), t = o.generateWsUrl(o.origin, n), null != window.WebSocket ? (o.log("creating new socket,", new Date), e = new WebSocket(t), o.websocket = e, o.websocket.onopen = function() {
                    ...
                    o.websocket == e && (window.clearTimeout(o.stableConnectionTimer), o.connected = !1, o.errorHandler(t))
        ...
        _onConnect: function() {
            if (this.reconnectionFlag) {
                const n = this;
                return this.connected = !0, void(n.channels && 0 < Object.keys(n.channels).length && Object.keys(n.channels).forEach(function(t) {
        ...
        io: function o(i, r, s) {
            ...
            47: [function(t, e, N) {
                ! function(t) {
                    ...
                    var u, _, S, I, a, A, n, T, p, h, o, B, l, E, R, f, d, y, g, m, i, r, s, b, O, v = new Date(-0xc782b5b800cec);
                    try {
                    ...
                    k("json") || (u = "[object Function]", _ = "[object Number]", S = "[object String]", I = "[object Array]", a = k("bug-string-char-index"), v || (A = Math.floor, n = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], T = function(t, e) {
                        ...
                        return h = null, (O = i ? 2 == i ? function(t, e) {
                            var n, o = {},
                                i = x.call(t) == u;
